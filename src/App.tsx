...
const navigation: NavItem[] = [
  ...
  { label: 'Repeat Order', icon: RotateCcw },
  ...
  { label: 'Pembayaran Masuk', icon: WalletCards },
...
setMonthlyRemainingPayment({
  ...
  <span>{formatDashboardCurrency(monthlyTripValue.USD, 'USD')}</span>
        ...
        <button type="button" className="stat-card stat-card--clickable" onClick={onOpenPaymentIn}>
          <div className="stat-card__top">
            <div>
          ...
          {active === 'Customers' ? (
            ...
            <RemainingPayments
              onOpenCustomer={(customerId) => {
                setCustomerIdToOpen(customerId)
                setActive('Customers')
              }}
            />
          ) : (
            <Dashboard
              onOpenRemainingPayments={() =>
                setActive('Sisa Pembayaran')
              }
              onOpenPaymentIn={() =>
